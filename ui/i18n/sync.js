...
I18N.add({
  ...
  'sync.menu.target': { de: 'Ziel', en: 'Goes to', fr: 'Destination', it: 'Destinazione' },
  'sync.menu.shared': { de: 'Gemeinsame Datei', en: 'Shared file', fr: 'Fichier commun', it: 'File comune' },
  'sync.menu.separate': { de: 'Eigene Mono-Datei', en: 'Mono file of its own', fr: 'Fichier mono à part', it: 'File mono a parte' },
  'sync.menu.position': { de: 'Position beim Mastern', en: 'Position when mastering', fr: 'Position au mastering', it: 'Posizione nel mastering' },
  'sync.menu.left': { de: 'Links', en: 'Left', fr: 'Gauche', it: 'Sinistra' },
  'sync.menu.middle': { de: 'Mitte', en: 'Middle', fr: 'Milieu', it: 'Centro' },
  'sync.menu.right': { de: 'Rechts', en: 'Right', fr: 'Droite', it: 'Destra' },
